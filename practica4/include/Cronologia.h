...
class Cronologia{
	private:
		...
		/** 
		* @brief Saber la posicion de un año en el vector
		* @param anio recibe como entrada un año
		* @return devuelve un entero
		*/
		int posicionAnio(int anio);
	...
	public:
		...
		*/
		...
		/** 
		* @brief Obtener numero de fechas que representa el util del vector
		* @return salida numero de fechas
		*
		*/
		...
		*/
		...
		/** 
		* @brief Inserta una fecha historica en una cronologia
		* en la posicion correspondiente
		* @param unaFecha recibe como entrada un objeto fecha historica
		*
		*/
		void insertarFecha(FechaHistorica unaFecha);
		...
		*/
		...
		/** 
		* @brief Ordena la cronologia
		*/
		void ordenarCronologia();
